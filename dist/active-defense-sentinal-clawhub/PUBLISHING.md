...
The skill is designed to preserve evidence, avoid silent remediation, and separate verified facts from suspicion before recommending the safest next step.
