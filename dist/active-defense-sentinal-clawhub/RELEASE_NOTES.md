...
This release packages a publishable defensive skill scaffold for clawhub.ai and restores the executable helper scripts that make the scanner workflow usable end to end.
...
- Executable helper scripts for scan, staged install, and quarantine flows
